...
```bash
wget https://github.com/baojie/gitty/releases/download/v0.2.1/gitty-desktop_0.2.1_amd64.deb
sudo dpkg -i gitty-desktop_0.2.1_amd64.deb
```
...
There is an [arm64 `.deb`](https://github.com/baojie/gitty/releases/download/v0.2.1/gitty-desktop_0.2.1_arm64.deb)
beside it, and an AppImage for distributions without dpkg
([x86_64](https://github.com/baojie/gitty/releases/download/v0.2.1/Gitty-0.2.1-x86_64.AppImage),
[arm64](https://github.com/baojie/gitty/releases/download/v0.2.1/Gitty-0.2.1-arm64.AppImage)) —
