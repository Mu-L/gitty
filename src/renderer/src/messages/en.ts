...
export const en: RendererMessages = {
  ...
  diff: {
    ...
    openLinkHint: 'Ctrl+click to open this in Gitty',
    ...
    formatJson: 'Format',
    formatJsonTitle: 'Show this JSON re-indented',
    jsonSourceTitle: 'Show the JSON as the file stores it',
  ...
  contextMenu: {
    ...
    openFolderInBrowser: 'Open in Browser',
    openFolderInFileManager: 'Open in File Manager',
