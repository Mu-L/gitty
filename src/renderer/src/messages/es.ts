...
export const es: RendererMessages = {
  ...
  settings: {
    ...
    readingMarks: 'Marcas de lectura',
    readingAnalyzer: 'Analizador',
    analyzerJieba: 'jieba',
    analyzerModel: 'Modelo',
    readingRules: 'Estilos de marca',
    readingModel: 'Acceso al modelo',
    openConfigFile: 'Abrir',
