...
export const ru: RendererMessages = {
  ...
  settings: {
    ...
    readingMarks: 'Пометки для чтения',
    readingAnalyzer: 'Анализатор',
    analyzerJieba: 'jieba',
    analyzerModel: 'Модель',
    readingRules: 'Стили пометок',
    readingModel: 'Доступ к модели',
    openConfigFile: 'Открыть',
