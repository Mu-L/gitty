...
export const ru: RendererMessages = {
  ...
  diff: {
    ...
    openLinkHint: 'Ctrl+щелчок — открыть это в Gitty',
    ...
    formatJson: 'Формат',
    formatJsonTitle: 'Показать этот JSON с отступами',
    jsonSourceTitle: 'Показать JSON так, как он записан в файле',
  ...
  log: {
    ...
    dateOutOfOrder:
      'Дата этой строки позже, чем у строки над ней. Журнал упорядочен по дате авторства, но происхождение важнее часов: родительский коммит всегда рисуется под своими потомками, а коммит после rebase или cherry-pick сохраняет дату, когда он был написан.',
    filter: 'Фильтр',
  ...
  contextMenu: {
    ...
    copyFolderName: 'Копировать имя папки',
    openFolderInBrowser: 'Открыть в браузере',
    openFolderInFileManager: 'Открыть в файловом менеджере',
