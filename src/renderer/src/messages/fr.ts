...
export const fr: RendererMessages = {
  ...
  diff: {
    ...
    openLinkHint: 'Ctrl+clic pour ouvrir ceci dans Gitty',
    ...
    formatJson: 'Formater',
    formatJsonTitle: 'Afficher ce JSON réindenté',
    jsonSourceTitle: 'Afficher le JSON tel que le fichier le stocke',
  ...
  settings: {
    ...
    instances: 'Instances',
    singleInstance: 'Une seule',
    multipleInstances: 'Plusieurs',
    shell: 'Shell',
  ...
  contextMenu: {
    ...
    copyFolderName: 'Copier le nom du dossier',
    openFolderInBrowser: 'Ouvrir dans le navigateur',
    openFolderInFileManager: 'Ouvrir dans le gestionnaire de fichiers',
