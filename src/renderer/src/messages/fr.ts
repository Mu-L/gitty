...
export const fr: RendererMessages = {
  ...
  settings: {
    ...
    readingMarks: 'Marques de lecture',
    readingAnalyzer: 'Analyseur',
    analyzerJieba: 'jieba',
    analyzerModel: 'Modèle',
    readingRules: 'Styles des marques',
    readingModel: 'Accès au modèle',
    openConfigFile: 'Ouvrir',
