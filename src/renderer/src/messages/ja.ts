...
export const ja: RendererMessages = {
  app: {
    ...
    help: {
      title: 'キーボードショートカット',
      close: '閉じる',
      sectionCommits: 'コミットとファイル',
      sectionViews: 'ビュー',
      sectionPanes: 'ペイン',
      sectionApp: 'アプリケーション',
      moveSelection: 'コミット一覧の選択を移動',
      showCommit: '選択したコミットを表示',
      markSecond: '2 つ目のコミットを選び差分を取る',
      openCommitPage: 'そのコミットのページをホスティングサイトで開く',
      openFileTab: 'ファイル見出しを新しいドキュメントタブで開く',
      find: 'ペインの内容を検索、またはファイルツリーを絞り込む',
      copy: '選択範囲をコピー（ウィンドウのどこでも）',
      paste: 'クリップボードのファイルをファイルツリーに貼り付け',
      backToChanges: '変更に戻る',
      browse: 'ワーキングツリーを閲覧',
      changesAllPanes: '変更に戻り、4 つのペインをすべて表示',
      navHistory: '表示した場所を戻る・進む',
      togglePanes: 'ファイル、差分、コミット、ターミナルを表示／非表示',
      allPanes: '4 つのペインをすべて表示し直す',
      fillWindow: 'そのペインでウィンドウを埋める',
      cyclePane: '全画面を次のペインへ、Shift で前へ',
  ...
  files: {
    ...
    keyBrowse: ' ワークツリーを閲覧（コミットとターミナルは退避）',
    keyChanges: ' 変更に戻り、4 つのペインをすべて表示',
  ...
  diff: {
    ...
    openLinkHint: 'Ctrl+クリックでこれを Gitty で開く',
    ...
    formatJson: '整形',
    formatJsonTitle: 'この JSON をインデントして表示する',
    jsonSourceTitle: 'ファイルに書かれたままの JSON を表示する',
    expandAll: 'すべて展開',
  ...
  contextMenu: {
    ...
    copyFolderName: 'フォルダー名をコピー',
    openFolderInBrowser: 'ブラウザーで開く',
    openFolderInFileManager: 'ファイルマネージャーで開く',
    deleteFile: 'ファイルを削除…',
    stageFile: 'ファイルをステージ',
