...
export const zh: RendererMessages = {
  ...
  diff: {
    ...
    historyRowHint: '单击选中 · 双击打开 · Shift+单击第二行比较两个版本',
    showWholeDiff: '全部',
    ...
    formatJson: '格式化',
    formatJsonTitle: '以缩进后的形式显示此 JSON',
    jsonSourceTitle: '改为显示文件中原本的 JSON',
    expandAll: '全部展开',
    collapseAll: '全部折叠',
  ...
  contextMenu: {
    ...
    openFolderInBrowser: '在浏览器中打开',
    openFolderInFileManager: '在文件管理器中打开',
    deleteFile: '删除文件…',
    stageFile: '暂存文件',
    unstageFile: '取消暂存文件',
    discardChanges: '丢弃更改…',
