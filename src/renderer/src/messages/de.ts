...
export const de: RendererMessages = {
  ...
  settings: {
    ...
    readingMarks: 'Lesemarkierungen',
    readingAnalyzer: 'Analysator',
    analyzerJieba: 'jieba',
    analyzerModel: 'Modell',
    readingRules: 'Markierungsstile',
    readingModel: 'Modellzugriff',
    openConfigFile: 'Öffnen',
