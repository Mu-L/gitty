...
export const de: RendererMessages = {
  ...
  diff: {
    ...
    formatJsonTitle: 'Dieses JSON eingerückt anzeigen',
    jsonSourceTitle: 'Das JSON so anzeigen, wie die Datei es speichert',
  ...
  contextMenu: {
    ...
    copyFolderName: 'Ordnernamen kopieren',
    openFolderInBrowser: 'Im Browser öffnen',
    openFolderInFileManager: 'Im Dateimanager öffnen',
