...
export const ko: RendererMessages = {
  app: {
    ...
    help: {
      title: '키보드 단축키',
      close: '닫기',
      sectionCommits: '커밋과 파일',
      sectionViews: '보기',
      sectionPanes: '창',
      sectionApp: '애플리케이션',
      moveSelection: '커밋 목록에서 선택 이동',
      showCommit: '선택한 커밋 보기',
      markSecond: '두 번째 커밋을 표시해 둘을 비교',
      openCommitPage: '그 커밋의 페이지를 호스팅 사이트에서 열기',
      openFileTab: '파일 제목을 새 문서 탭으로 열기',
      find: '창에 보이는 것에서 찾기, 또는 파일 트리 거르기',
      copy: '선택 영역 복사 — 창 어디서나',
      paste: '클립보드의 파일을 파일 트리에 붙여넣기',
      backToChanges: '변경 사항으로 돌아가기',
      browse: '작업 트리 둘러보기',
      changesAllPanes: '변경 사항으로 돌아가며 네 창을 모두 표시',
      navHistory: '살펴본 위치를 뒤로, 앞으로',
      togglePanes: '파일, 차이, 커밋, 터미널 숨기기 또는 보이기',
      allPanes: '네 창을 다시 모두 표시',
      fillWindow: '그 창으로 윈도를 가득 채우기',
      cyclePane: '전체 화면을 다음 창으로, 또는 이전 창으로',
      shortcuts: '이 단축키 목록',
    ...
    menuTitle: (accel: string) => `메뉴 표시/숨기기（${accel}）`,
    panes: '창',
    noRepo: '저장소 없음',
  ...
  diff: {
    ...
    formatJson: '정렬',
    formatJsonTitle: '이 JSON을 들여쓰기해 보기',
    jsonSourceTitle: '파일에 저장된 그대로의 JSON 보기',
    expandAll: '모두 펼치기',
    collapseAll: '모두 접기',
  ...
  contextMenu: {
    ...
    copyFolderName: '폴더 이름 복사',
    openFolderInBrowser: '브라우저에서 열기',
    openFolderInFileManager: '파일 관리자에서 열기',
    deleteFile: '파일 삭제…',
    stageFile: '파일 스테이지',
